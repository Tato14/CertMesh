...
class CuratedPath(BaseModel):
    ...
    # Optional natural-language coaching gloss generated by the Foundry model.
    # NOT a grounded claim (the critic never checks it) — it only rephrases the
    # already-grounded summary. None when no model is configured (offline).
    narrative: str | None = None
    narrative_source: str | None = None   # "foundry" when model-generated
